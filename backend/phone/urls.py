...
urlpatterns = [
    ...
    # Admin
    path('admin/reviews/',        views.admin_list_reviews),
    path('admin/reply/',          views.admin_reply),
    path('admin/reply/delete/',   views.admin_delete_reply),
